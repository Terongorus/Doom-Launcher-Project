...
namespace Doom_Launcher_Project
{
    ...
    public class Game_Options
    {
        ...
        {
            string ProductName = Assembly.GetExecutingAssembly().GetName().Name ?? "Doom Launcher";
            string ProductVersion = Assembly.GetExecutingAssembly().GetName().Version?.ToString() ?? "Unknown";
            //string ProductOwner = Assembly.GetExecutingAssembly().GetCustomAttribute<AssemblyCompanyAttribute>()?.Company ?? "Unknown";
