namespace Doom_Launcher_Project
{
    public partial class Launcher_Window : Form
    {
        ...
        private void Launcher_Window_Shown(object? sender, EventArgs e)
        {
            // Runs after the main window is visible so the scan dialog has a parent to center on.
            AutoScan_Options auto_scan_options = new AutoScan_Options();
            auto_scan_options.RunFirstLaunchScanIfNeeded(this);
        }
